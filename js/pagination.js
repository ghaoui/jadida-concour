(function($){
	...
	var number_of_items = $('#content-press .row1').children().size();
	...
	*/
	...
	$('#content-press .row1').children().css('display', 'none');
	
	//and show the first n (show_per_page) elements
	$('#content-press .row1').children().slice(0, show_per_page).css('display', 'block');
...
go_to_page = function(page_num){
	...
	$('#content-press .row1').children().css('display', 'none').slice(start_from, end_on).css('display', 'block');
